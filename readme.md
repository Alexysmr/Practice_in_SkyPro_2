...
src\class_category.py - модуль содержит: класс Category описания категорий товаров; класс CategorysIteration выполнения  
итераций с экземплярами класса; класс Order, выводящий информацию о заказе позиций товара из экземпляра класса в консоль;  
src\class_product.py - модуль содержит: базовый класс BaseProduct; класс Product описания товаров; класс  
PrintProductMixin выводящий информацию о создаваемом экземпляре класса в консоль;  
